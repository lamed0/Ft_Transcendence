...
function Buttons(props) {
  ...
  return (
    <div className="m-15 ml-4">
        ...
        <p className="text-white m-[30px] text-[1.25rem]  ">don't have an account ? <Link className="text-blue-500" to="/SignUp">sign up here </Link> or <button onClick={addGuest}  className="text-blue-500">enter as Guest!</button></p>
