...
export class FriendsController {
    ...
    // async deleteReq(@Req() req: any, @Param('userId', ParseIntPipe) userId: number){
    //     return this.friendsSevice.rejectReq(req.user.id, userId);
    // }

    // @Delete(':userId')
    // deleteFriend(@Req() req: any, @Param('userId', ParseIntPipe) userId: number){
    //     return this.friendsSevice.removeFriend(req.user.id, userId);
    // }
