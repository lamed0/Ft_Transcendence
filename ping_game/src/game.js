...
export class Game{
    constructor(inputArray) {
        ...
        this.scoreP2 = 0;
        this.round = 0;
        this.roundWinsP1 = 0; // Track rounds won by player 1
        this.roundWinsP2 = 0; // Track rounds won by player 2
        this.lastHit = 0;
    ...
    update(deltaTime){  
        ...
        if(this.scoreP1 >= 10 || this.scoreP2 >= 10){
            ...
            // Check if someone has won 2 rounds (match winner is first to win 2/3)
            if (this.round === 3) {
                this.ball.vx = 0;
                this.ball.vy = 0;
